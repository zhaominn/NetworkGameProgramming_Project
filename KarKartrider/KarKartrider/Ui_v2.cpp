...
Ui_v2::Ui_v2(string name, string path, string obj_name, string obj_type, bool rigid_status, glm::mat4 start_matrix)
{
...
void Ui_v2::load_obj(string name, string path, string obj_name, string obj_type, glm::mat4 start_matrix)
{
    read_obj_file(name, path, this, obj_name, obj_type);
    this->translateMatrix = start_matrix * this->translateMatrix;
}

const void Ui_v2::draw(GLint shaderProgramID, bool(*isKeyPressed_s)(const char&))
{
